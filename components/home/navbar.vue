<template>
  <div class="navs">
        ...
        >
          ...
          <div class="col-4">
            <div class="d-flex justify-content-end align-items-center">
              <nuxt-link to="/about">बारेमा</nuxt-link>
              ...
              <div class="weather" v-if="temp != ''">
                <div class="d-flex align-items-center">
                  ...
                  <div class="details d-flex flex-column align-items-center">
                    ...
                    <div class="location">काठमाडौं</div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="empty-nav d-none"></div>
          ...
          <div class="col-10">
            <div class="title pl-3">
              <div class="row d-flex align-items-center w-100">
                ...
                <div class="display-4">गुनासो चौतारी</div>
              </div>
            </div>
          </div>
  ...
  mounted: function () {
    ...
    navbar =
      window.innerWidth >= 768
        ? document.querySelector('.navbar-1')
        : document.querySelector('.navbar-2')
    var emptyNav = document.querySelector('.empty-nav')
    ...
    function myFunction() {
      if (window.pageYOffset >= sticky) {
        ...
        emptyNav.classList.remove('d-none')
      } else {
        navbar.classList.remove('sticky')
        emptyNav.classList.add('d-none')
      }
    }
