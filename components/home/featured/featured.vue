<template>
  <div class="featured-news">
    <div class="d-flex featured-title justify-content-between">
      <h3>विशेष समाचार</h3>

      <div class="mCarousel-btns d-none d-lg-flex">
        <a
          class="carousel-control-prev"
          href="#featuredCarousel-lg"
          role="button"
          data-slide="prev"
        >
      ...
      <div class="mCarousel-btns d-none d-md-flex d-lg-none">
        <a
          class="carousel-control-prev"
          href="#featuredCarousel-md"
          role="button"
          data-slide="prev"
        >
          <i class="fas fa-chevron-left"></i>
      ...
      <div class="mCarousel-btns d-flex d-md-none">
        <a
          class="carousel-control-prev"
          href="#featuredCarousel-sm"
          role="button"
          data-slide="prev"
        >
          <i class="fas fa-chevron-left"></i>
